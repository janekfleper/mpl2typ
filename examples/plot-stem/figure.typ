...
#let axes-0(
  xlim: (-0.20915926535897936, 6.592344572538566),
  ylim: (-0.13553254873506457, 2.8461835234363555),
  dpi: 100.0,
) = {
  ...
  let yaxis-major-ticks = (
    locs: (-0.5, 0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0),
    labels: ($−0.5$, $0.0$, $0.5$, $1.0$, $1.5$, $2.0$, $2.5$, $3.0$),
    tick-style: (direction: "out", line: (length: 3.5pt, angle: 0deg, stroke: color.rgb("#000000") + 0.8pt)),
    label-style: (pad: 3.5pt, rotation: -0.0deg, text: (size: 1em, fill: color.rgb("#000000"))),
  )

  let fill-collection-0 = ()
  let stroke-collection-0 = (paint: color.rgb(12.157%, 46.667%, 70.588%), thickness: 1.5pt, dash: none)
  ...
  let marker-line-1 = markers.circle(
    3.0pt,
    fill: color.rgb(12.157%, 46.667%, 70.588%),
    stroke: color.rgb(12.157%, 46.667%, 70.588%) + 1.0pt,
  )
  let line-1 = (data: data.at("line-1"), stroke: stroke-line-1, marker: marker-line-1, transform: transform)

  let stroke-line-2 = (
    paint: color.rgb(83.922%, 15.294%, 15.686%),
    thickness: 1.5pt,
    cap: "butt",
    join: "round",
    dash: "solid",
