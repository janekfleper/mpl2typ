...
#let axes-0(xlim: (-3.0, 3.0), ylim: (-3.0, 3.0), dpi: 100.0) = {
  ...
  let xaxis-major-ticks = (
    locs: (-3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0),
  ...
  let fill-collection-0 = (color.luma(50.0%),)
  let stroke-collection-0 = (
    paint: (color.rgb(100.0%, 0.0%, 0.0%), color.rgb(0.0%, 0.0%, 100.0%)),
    thickness: 1pt,
    dash: none,
  )
...
#let figure(width: 25.4cm, height: 15.24cm) = {
  show: figure-style
  block(
    width: width,
    height: height,
